...
const CropPrediction = () => {
  ...
  const [crop_type, setCrop] = useState("1");
    ...
    <View style={styles.headerContainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubText}>
          You can predict the future Yeild of coconut through this
        </Text>
      </View>
    </View>
  );
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      setData(responseJson.yield)
      setData1(responseJson.yield_count)
    ...
    return (
      <ModalOverlay visible={modal} onRequestClose={!modal}>
        <View
          ...
          <Text style={{ marginBottom: 20,fontWeight: 'bold',fontSize:20 }}>Predicted Coconut Yield :</Text>
          <Image
          ...
          <Text style={{ marginVertical: 15,fontSize:20,marginLeft:-37,marginTop:40 }}>Monthly Yield Prediction per coconut tree: </Text>
          <Text style={{ marginVertical: 15,fontSize:20, fontWeight: 'bold',marginTop:-13}}> {data}</Text>
          <Text style={{ marginVertical: 15,fontSize:20,marginLeft:-8,marginTop:-4 }}>Monthly Yield Prediction for your state:</Text>
          <Text style={{ marginVertical: 15,fontSize:20,fontWeight: 'bold',marginTop:-14 }}> {data1}</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.itemContainer}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                <Picker.Item label="Coconut" value="1" />
      ...
      <View style={styles.itemContainer}>
        ...
        <View style={styles.itemContainer}>
        <Text style={styles.bodyText}>Crop Count</Text>
          <TextInput
            keyboardType='numeric'
            style={styles. textContainer}
            placeholder = 'Please give Wet Days '
