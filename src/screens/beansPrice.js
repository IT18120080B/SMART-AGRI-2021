...
const beansPrice = () => {
  ...
  const [vegitable, setVegitable] = useState('3');
  ...
  const Header = () => (
    <View style={styles.headerContainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Beans Price Prediction</Text>
        <Text style={styles.headerSubText}>
          You can predict the future price of beans through this
        </Text>
      </View>
    </View>
  );
    ...
    return (
      <ModalOverlay visible={modal} onRequestClose={!modal}>
        <View
          ...
          <Text style={{ marginBottom: 20,fontWeight: 'bold',fontSize:20 }}>Predicted  beans Price :</Text>
          <Image
        ...
        <View style={styles.itemContainer}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                <Picker.Item label="Beans" value="3" />
