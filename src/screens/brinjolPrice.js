...
const brinjolPrice = () => {
  ...
  const [vegitable, setVegitable] = useState('5');
  ...
  const Header = () => (
    <View style={styles.headerContainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Brinjal Price Prediction</Text>
        <Text style={styles.headerSubText}>
          You can predict the future price of brinjal through this
        </Text>
      </View>
    </View>
  );
    ...
    return (
      <ModalOverlay visible={modal} onRequestClose={!modal}>
        <View
          ...
          <Text style={{ marginBottom: 20,fontWeight: 'bold',fontSize:20 }}>Predicted  brinjal Price :</Text>
          <Image
             source={require('../images/brinjol.png')}
              resizeMode="contain"
        ...
        <View style={styles.itemContainer}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                <Picker.Item label="Brinjal" value="5" />
