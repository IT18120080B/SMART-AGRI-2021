  ...
  const Header = () => (
    <View style={styles.headerContainer}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Ginger Yield Prediction</Text>
    ...
    return (
      <ModalOverlay visible={modal} onRequestClose={!modal}>
        <View
          ...
          <Text style={{ marginBottom: 20,fontWeight: 'bold',fontSize:20 }}>Predicted Ginger Yield :</Text>
          <Image
          ...
          <Text style={{ marginVertical: 15,fontSize:20,marginLeft:-4,marginTop:40 }}>Monthly Yield Prediction for Ginger: </Text>
      ...
      <View style={styles.itemContainer}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                <Picker.Item label="Ginger" value="2" />
