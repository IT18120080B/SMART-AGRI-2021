...
const tomatoCrop = () => {
  ...
  const [crop_type, setCrop] = useState("3");
  ...
  const Header = () => (
    <View style={styles.headerContainer}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Tomato Yield Prediction</Text>
        <Text style={styles.headerSubText}>
          You can predict the future Yeild of tomato through this
        </Text>
      </View>
    </View>
  );
    ...
    return (
      <ModalOverlay visible={modal} onRequestClose={!modal}>
        <View
          ...
          <Text style={{ marginBottom: 20,fontWeight: 'bold',fontSize:20 }}>Predicted Tomato Yield :</Text>
          <Image
          ...
          <Text style={{ marginVertical: 15,fontSize:20,marginLeft:-4,marginTop:40 }}>Monthly Yield Prediction for Tomato: </Text>
      ...
      <View style={styles.itemContainer}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                <Picker.Item label="Tomato" value="3" />
