...
const tomatoPrice = () => {
  ...
  const [vegitable, setVegitable] = useState('4');
  ...
  const Header = () => (
    <View style={styles.headerContainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Tomato Price Prediction</Text>
        <Text style={styles.headerSubText}>
          You can predict the future price of tomato through this
        </Text>
      </View>
    </View>
  );
    ...
    return (
      <ModalOverlay visible={modal} onRequestClose={!modal}>
        <View
          ...
          <Text style={{ marginBottom: 20,fontWeight: 'bold',fontSize:20 }}>Predicted  Tomato Price :</Text>
          <Image
        ...
        <View style={styles.itemContainer}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                <Picker.Item label="Tomato" value="4" />
